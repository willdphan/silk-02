...
// ... and so on for all the functions that are giving errors
...
// void setup() {
//   Serial.begin(115200);
//   delay(10000); // Wait a bit for serial connection to establish
...
void config_init() {
  ...
  // config.frame_size = FRAMESIZE_QQVGA; // Smaller frame size
  // config.pixel_format = PIXFORMAT_GRAYSCALE; // Less memory-intensive format
